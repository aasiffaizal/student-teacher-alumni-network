    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li ><a href="<?php echo base_url(); ?>index.php/home"><span class="glyphicon glyphicon-user"></span>Profile</a></li>
                  ...
                  <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                          ...
                          <span class="site-name"><b><?php foreach($record as $row){ echo $row->Name;}?></b><span>
                             <a href="#" class="btn btn-success" data-toggle="modal" data-target="#compose-modal"><span class="glyphicon glyphicon-envelope"></span> Send message</a>
        ...
        <div class="col-lg-6">
         ...
         <ul class="details1 basic">
            ...
            <li>Year :
                ...
                <?php foreach($details as $row){ echo $row->Year; }?></li><?php }?>
             <li>Branch :
                <?php foreach($details as $row){ echo $row->Branch; }?></li>
                <?php foreach($record as $row){ $Type=$row->Type;} 
              if($Type=='Alumni')
                {?>
                    ...
                    <div class="modal-wrapper">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo base_url(); ?>index.php/message/send/<?php foreach($record as $row){echo $row->No;}?>/<?php foreach($record as $row){ echo $row->username;}?>/<?php foreach($record as $row){ echo $row->Type;}?>" method="post">
                            <div class="modal-body">
                              <div class="form-group">
                                <input name="to" type="text" value="<?php foreach($record as $row){echo $row->Name;}?>" class="form-control" placeholder="To">
                              </div>
                              
                              <div class="form-group">
                                <textarea name="message" id="message" class="form-control" placeholder="Message" style="height: 320px;"></textarea>
                              </div>
